<?php
/**
 * Company Panel - Conversation Template
...
<head>
    ...
    <title>Conversacion con <?= htmlspecialchars($sponsor['name']) ?></title>
...
<body>
    <div class="conversation-layout">
        ...
        <header class="conversation-header">
            <a href="/empresa/mensajes/<?= $event['id'] ?>" class="back-btn">
                <i class="fas fa-arrow-left"></i>
            </a>
            <?php if (!empty($sponsor['logo_url'])): ?>
                <img src="<?= htmlspecialchars($sponsor['logo_url']) ?>" alt="" class="header-logo">
            <?php else: ?>
                <div class="logo-placeholder"><i class="fas fa-briefcase"></i></div>
            <?php endif; ?>
        ...
        <div class="messages-container" id="messagesContainer">
            ...
            <?php else: ?>
                <?php foreach ($messages as $msg): ?>
                    <?php $isMine = ($msg['sender_type'] === 'company' && $msg['sender_id'] == $company['id']); ?>
            ...
            <?php else: ?>
                <?php if (empty($messages)): ?>
                    <div class="info-message">
                        ...
                        <span>Puedes enviar un mensaje inicial. Si el sponsor responde, podras continuar la conversacion.</span>
                    </div>
                <?php endif; ?>
        ...
        if (form) {
            form.addEventListener('submit', async function(e) {
                ...
                try {
                    ...
                    const endpoint = isReply ? '/empresa/mensaje/responder' : '/empresa/mensaje/enviar';
