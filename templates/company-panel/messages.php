<?php
/**
 * Company Panel - Messages Template
        ...
        <aside class="panel-sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="/empresa/sponsors/<?= $event['id'] ?>" class="nav-item">
                    <i class="fas fa-briefcase"></i> Ver Sponsors
                </a>
                <a href="/empresa/matches/<?= $event['id'] ?>" class="nav-item">
                    <i class="fas fa-heart"></i> Mis Matches
                </a>
                <a href="/empresa/mensajes/<?= $event['id'] ?>" class="nav-item active">
            ...
            <div class="sidebar-footer">
                <a href="/empresa/logout" class="btn btn-outline btn-block">
        ...
        <main class="panel-main">
            ...
            <?php if (empty($inbox)): ?>
                <div class="empty-state">
                    ...
                    <p>Aun no tienes conversaciones. Explora los sponsors y enviales un mensaje para empezar.</p>
            ...
            <?php else: ?>
                <div class="conversation-list">
                    <?php foreach ($inbox as $conversation): ?>
                        <a href="/empresa/mensajes/<?= $event['id'] ?>/<?= $conversation['other_party_id'] ?>" class="conversation-item <?= $conversation['unread_count'] > 0 ? 'unread' : '' ?>">
