...
<section class="block block-text-image section <?= $renderer->getBlockClasses($block, $settings) ?>" style="<?= $customStyles ?><?= $renderer->getBlockStyles($settings) ?>">
    <div class="container">
        <div class="text-image-grid image-left">
            <!-- Image Content -->
            <div class="image-content" <?= $animAttrs ? str_replace('data-animate="', 'data-animate="slide-left-', $animAttrs) : 'data-animate="fade-in-left"' ?>>
            ...
            <!-- Text Content -->
            <div class="text-content" <?= $animAttrs ?: 'data-animate="fade-in-right"' ?>>
...
.block-text-image .text-image-grid.image-left {
    direction: ltr;
}
