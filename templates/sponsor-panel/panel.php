...
<div class="panel-layout">
    ...
    <main class="panel-main">
        <header class="panel-header">
            <h1>Bienvenido, <?= htmlspecialchars($sponsor['name']) ?></h1>
            <?php if ($currentEvent): ?>
        ...
        <?php if (!$currentEvent): ?>
            <div class="empty-state">
                ...
                <p>Actualmente no participas en ningún evento activo. Te notificaremos cuando haya uno disponible.</p>
            </div>
        <?php else: ?>
            <!-- Stats Cards -->
            <div class="stats-grid">
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        <span class="stat-value"><?= $stats['total_selections'] ?> / <?= $stats['max_selections'] ?></span>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        <span class="stat-value"><?= $stats['remaining_selections'] ?></span>
                    ...
                    <?php foreach (array_slice($matches, 0, 4) as $match): ?>
                        <div class="match-card">
                            ...
                            <div class="match-info">
                                ...
                                <small><?= htmlspecialchars($match['company_sector'] ?? '') ?></small>
                            </div>
