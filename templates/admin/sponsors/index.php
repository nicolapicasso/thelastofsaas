...
<div class="card filters-card">
    <form method="GET" action="/admin/sponsors" class="filters-form">
        ...
        <?php if ($currentActive !== null || $currentCategory): ?>
                    ...
                    <?php foreach ($sponsors as $sponsor): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if ($sponsor['contact_emails']): ?>
                                    <br><small class="text-muted"><?= htmlspecialchars(explode(',', $sponsor['contact_emails'])[0]) ?></small>
                                <?php endif; ?>
                            </td>
                            <td>
                                <?php if ($sponsor['category']): ?>
                                    <span class="badge badge-info"><?= htmlspecialchars($sponsor['category']) ?></span>
                                <?php else: ?>
